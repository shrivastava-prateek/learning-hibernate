...
public class Main {
	...
	public static void main(String[] args) {
		...
		c1.addProfile(new Profile("school1","college1"));
		c2.addProfile(new Profile("school2","college2"));
		c3.addProfile(new Profile("school3","college3"));
		c4.addProfile(new Profile("school4","college4"));
		c5.addProfile(new Profile("school5","college5"));
		c6.addProfile(new Profile("school6","college6"));
		c7.addProfile(new Profile("school7","college7"));
		c8.addProfile(new Profile("school8","college8"));
